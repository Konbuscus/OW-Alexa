...
describe('extending handlers', function() {
    it('should handle a single handler for all platforms (alexa)', function(done) {
        this.timeout(1000);
        ...
        let requestAlexa = RequestBuilderAlexaSkill
            .intentRequest()
    ...
    it('should handle a single handler for all platforms (google action)', function(done) {
        this.timeout(1000);
    ...
    it('should extend handler with alexa specific handler (alexa request)', function(done) {
        this.timeout(1000);
        ...
        app.on('respond', function(jovo) {
            let response = jovo.getPlatform().getResponse();
            assert.ok(response.isTell('Hello Alexa'));
            done();
        });
    ...
    it('should extend handler with google action specific handler (alexa request)', function(done) {
        this.timeout(1000);
    ...
    it('should handle extended alexa handler without existing intent (alexa request)', function(done) {
        this.timeout(2000);
